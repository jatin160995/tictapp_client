...
class Chat extends StatefulWidget {
  ...
  Chat(this.orderId, this.tableName);
...
class _ChatState extends State<Chat> {
  ...
  void createRecord(String text, String type) async {
    ...
    DocumentReference ref = await databaseReference.collection(widget.tableName).document(widget.orderId).collection("messages")
        .add({
      'type': type,
      'message': text,
                  ...
                  children: <Widget>[
                    Expanded(
                      child: StreamBuilder<QuerySnapshot>(
                        stream: _firestore
                            .collection(widget.tableName).document(widget.orderId).collection("messages")
