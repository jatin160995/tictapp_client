...
import 'package:tictapp/widget/view_all_grid.dart';


class ViewAllProduct extends StatefulWidget {

  dynamic categoryList;
  ViewAllProduct({Key key, @required this.categoryList}) : super(key: key);
...
class _ViewAllProductState extends State<ViewAllProduct> {
  ...
  List<Widget> createTabBarView()
  {
      ...
      for(int i = 0; i < categoryList.length; i ++)
      {
        viewList.add(ViewAllProductGrid(categoryList[i]));
      }
