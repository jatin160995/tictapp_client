  ...
  getImage()
{
  String image = "http://";
    ...
    try{
      image = url_string+"image/"+widget.productData['image'];
      print(image); //cartProdImages[cartProdTitle.indexOf(widget.productData['name'])];
    }
    catch(e)
    {
      image = "http://";
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: Text(
                          inr+double.parse(widget.productData['price'].toString()).toStringAsFixed(2),
                          style: TextStyle(
                              color: primaryColor,
